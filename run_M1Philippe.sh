...
cp -r results resultsp63D1e12
rm results/*
mpirun -np 8 nth -p 6 -m data/cube01_hex.mesh -rs 4 -tf 0.0 -ok 1 -ot 0 -vis -fa -print -a0 1e11 | tee M1Philippe_p63D1e11.out
cp -r results resultsp63D1e11
rm results/*
mpirun -np 8 nth -p 6 -m data/cube01_hex.mesh -rs 4 -tf 0.0 -ok 1 -ot 0 -vis -fa -print -a0 1e10 | tee M1Philippe_p63D1e10.out
cp -r results resultsp63D1e10
rm results/*
