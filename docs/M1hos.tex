...
\begin{equation}
  ...
  + \frac{1}{r^2}\pdv{f}{\phi}\vect{b}_\phi ,
  \nonumber
\end{equation}
...
\begin{multline}
  ...
  + \pdv{}{\theta}\left(\frac{f_{,\theta}}{\sin(\phi)}\right)
  + \pdv{}{\phi}\left(\sin(\phi) f_{,\phi} \right) \right) \\
...
The~curl applied on a~vector field $\vect{v}$ in spherical coordinates based on
\eqref{eq:general_curlvec} reads
\begin{eqnarray}
  (\nabla\times\vect{v})(r) &=& (\nabla\times\vect{v})^r 
