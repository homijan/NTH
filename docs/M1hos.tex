...
\begin{figure}[tbh]
  \begin{center}
    \begin{tabular}{cc}
      \includegraphics[width=0.55\textwidth]{fe_data/correction_fit.png} &
      \includegraphics[width=0.55\textwidth]{fe_data/diff_f1_Z1.png} \\
      \includegraphics[width=0.55\textwidth]{fe_data/diff_f1_Z10.png} &
      \includegraphics[width=0.55\textwidth]{fe_data/diff_f1_Z50.png}
    \end{tabular}
  \caption{
  Analytic fit to the~Z correction of the~diffusion asymptotic of AWBS 
  with respect to SH.
  }
  \end{center}
