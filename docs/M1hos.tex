...
\begin{comment} % LAGHOS-NTH fig
\begin{figure}[htbp]
\centering
  %\includegraphics[height=2in]{figs_NTH/nth_sedov.png} \\
  \includegraphics[height=0.3\textwidth]{presentation/figs_NTH/nth_sedov.png}
  \begin{tabular}{cc}
...
\begin{eqnarray}
  \vn\cdot\nabla f 
  &=& - \frac{\qe}{\me\vmag}\left(\E + \frac{\vmag}{c}\vn\times\B\right)\cdot
  \left[ \pdv{f}{r}\vn 
  + \frac{1}{r}\pdv{f}{\phi}\vect{e}_\phi
  + \frac{1}{r\sin(\phi)}\pdv{f}{\theta}\vect{e}_{\theta} \right] 
  \nonumber \\
  ...
  \left[E(\vmag)\vn 
  + E(\phi)\vect{e}_\phi
  + E(\theta)\vect{e}_\theta \right] 
  + \frac{\vmag}{c}
  \left[B(\phi)\vect{e}_\theta 
  - B(\theta)\vect{e}_\phi \right] \Big)\cdot 
  \nonumber \\
  && \left[ \pdv{f}{r}\vn 
  + \frac{1}{r}\pdv{f}{\phi}\vect{e}_\phi
  + \frac{1}{r\sin(\phi)}\pdv{f}{\theta}\vect{e}_{\theta} \right] 
  ...
  + \frac{1}{\sin^2(\phi)}\frac{\partial^2f}{\partial\theta^2} \right)
  \nonumber \\
  &=& - \frac{\qe}{\me\vmag}\Bigg(
  \left[ E(\vmag)\pdv{f}{r} + \frac{E(\phi)}{r}\pdv{f}{\phi}
  + \frac{E(\theta)}{r\sin(\phi)}\pdv{f}{\theta} \right]
  \nonumber \\ 
  &+& \frac{\vmag}{c}
  \left[\frac{B(\phi)}{r\sin(\phi)}\pdv{f}{\theta}
  - \frac{B(\theta)}{r}\pdv{f}{\phi} \right] \Bigg)
  \nonumber \\
  &+& \frac{\left(\fM - f\right)}{\lambda^e} 
  + \frac{1}{2 \lambda^{ei}} 
  \left(\pdv{}{\mu}\left((1 - \mu^2)\pdv{f}{\mu}\right)
...
\begin{multline}
  \vn\cdot\nabla f + \frac{1}{\vmag} \left[ \tE\cdot\vn \pdv{f}{r} 
  + \frac{\tE\cdot\vect{e}_\phi - \vmag\tB\cdot\vect{e}_\theta}{r}\pdv{f}{\phi}
  + \frac{\tE\cdot\vect{e}_\theta + \vmag\tB\cdot\vect{e}_\phi}
  {r\sin(\phi)}\pdv{f}{\theta} \right] 
  =\\
  \frac{\left(\fM - f\right)}{\lambda^e} 
  + \frac{1}{2 \lambda^{ei}} 
  \left(\pdv{}{\mu}\left((1 - \mu^2)\pdv{f}{\mu}\right)
